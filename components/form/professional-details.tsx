...
import { ArrowDown, ArrowDownNarrowWide, ChevronDown, Plus, Trash } from "lucide-react";
            ...
            {fields.map((f, idx) => {
                ...
                return (
                    <Collapsible
                        ...
                        key={idx}
                    >
                        <CollapsibleTrigger asChild className="w-full justify-between">
                            <Button
                        ...
                        <CollapsibleContent>
                            <div key={f.id} className="mb-6 p-4">
                                <FieldGroup>
                                    <Controller
